...
| 5 | 관리자 키를 어떻게 할까 (위 1번) | 박스 파일만 삭제. 교체는 선택 |
...
| 단계 | 내용 |
|---|---|
| **0. 즉시** | 박스의 관리자 키 파일 삭제, idle-watch CPU 기준 수정(§5-8) |
